from decoder import decode, encoding
...
if __name__ == "__main__":
    ...
    decoded = decode(text).decode(encoding)
    
    print(f"Original: {len(text)} bytes, Encoded: {len(encoded)} bytes, Decoded: {len(decoded)} bytes")
